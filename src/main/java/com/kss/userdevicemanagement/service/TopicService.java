...
public class TopicService {
    ...
    public void subscribeTopic(SubscribeTopicRequest subscribeTopicRequest) throws ApiException {
        ...
        if (topicRepository.existsByIdEqualsAndStatusEquals(subscribeTopicRequest.getTopicId(), true)) {
            Optional<UserTopic> optionalUserTopic = userTopicRepository.findByTopicIdAndUserId(subscribeTopicRequest.getTopicId(), subscribeTopicRequest.getUserId());
            ...
            UserTopic userTopic = UserTopic.builder()
                    ...
                    .topicId(subscribeTopicRequest.getTopicId())
